...
$email=$_POST['email'];
 $mobnum=$_POST['mobnum'];
    ...
    echo '<script>alert("Thông tin liên hệ đã được cập nhật.")</script>';
  }
  else
    {
...
<head>
  <title>Quản trị viên | Thông tin liên hệ</title>
      ...
      <div class="main-content">
        <div class="wrap-content container" id="container">
          ...
          <section id="page-title">
            <div class="row">
              <div class="col-sm-8">
                <h1 class="mainTitle">Quản trị viên | Thông tin liên hệ</h1>
              </div>
              <ol class="breadcrumb">
                <li>
...
?>
                  ...
                  <div class="form-group">
                    <label for="exampleInputUsername1">Địa chỉ Email</label>
                    <input type="email" class="form-control" name="email" value="<?php  echo $row['Email'];?>"
                      required='true'>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputUsername1">Số điện thoại</label>
                    <input type="text" class="form-control" name="mobnum" value="<?php  echo $row['MobileNumber'];?>"
