...
$_SESSION['msg']="Đã thêm chuyên khoa bác sĩ thành công!!";
}
//Code Deletion
if(isset($_GET['del']))
{
      ...
      <div class="main-content">
        <div class="wrap-content container" id="container">
          <section id="page-title">
            <div class="row">
              <div class="col-sm-8">
                <h1 class="mainTitle">Quản trị viên | Thêm chuyên gia bác sĩ</h1>
              </div>
              <ol class="breadcrumb">
                <li>
                ...
                <li class="active">
                  <span>Thêm chuyên gia bác sĩ</span>
                </li>
              </ol>
            </div>
          </section>
                        ...
                        <form role="form" name="dcotorspcl" method="post">
                          <div class="form-group">
                            ...
                            <input type="text" name="doctorspecilization" class="form-control"
                              placeholder="Nhập tên chuyên khoa bác sĩ cần thêm">
                          </div>
