...
if($sql)
{
echo "<script>alert('Thông tin bác sĩ đã được cập nhật thành công');</script>";
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Chỉnh sửa</h5>
												</div>
...
<p><b>Ngày tạo hồ sơ: </b><?php echo htmlentities($data['creationDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Lần cuối cập nhật hồ sơ: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
<hr />
