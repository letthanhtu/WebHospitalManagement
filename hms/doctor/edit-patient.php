...
if($sql)
{
echo "<script>alert('Thông tin bệnh nhân đã được cập nhật thành công');</script>";
...
<html lang="en">
	<head>
		<title>Doctor | Change Patient's Information</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Bác sĩ | Thêm bện nhân</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Bệnh nhân</span>
